...
import { createNoteController,getNoteController, searchNoteController, deleteNoteController,togglePinNoteController,toggleArchiveNoteController,shareNoteController,updateNoteController } from "../controller/noteController.js";
...
router.post("/notes",authMiddleware,validationMiddleware(noteValidator),createNoteController);
